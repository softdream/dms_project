...
float Tracker::CalculateIou(const Rect& det, const Track& track) {
...
void Tracker::AssociateDetectionsToTrackers(const std::vector<Rect>& detection,
...
void Tracker::Run(const std::vector<Rect>& detections) {
